...
import '../viewmodel/question_coontroller.dart';

class LeavingVehicleScreen extends StatefulWidget {
  const LeavingVehicleScreen({super.key});

  @override
  State<LeavingVehicleScreen> createState() => _LeavingVehicleScreenState();
}

class _LeavingVehicleScreenState extends State<LeavingVehicleScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryLeavingVehicleProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
        Provider.of<LorryLeavingVehicleProvider>(context, listen: false);
    provider.saveCategory("leaving_vehicle");
  }
  ...
  void correctAnswer(List<String> correctAnswers) {
    final provider =
        Provider.of<LorryLeavingVehicleProvider>(context, listen: false);
    provider.saveWrongAnswerList(correctAnswers);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryLeavingVehicleProvider>(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                      ...
                      _pageController.nextPage(
                        ...
                        : () async {
                      final provider =
                      Provider.of<LorryLeavingVehicleProvider>(
                          context,
                          listen: false);
                      final correctAnswer =
