...
class LorryDocumentScreen extends StatefulWidget {
  const LorryDocumentScreen({super.key});

  @override
  State<LorryDocumentScreen> createState() => _LorryDocumentScreenState();
}

class _LorryDocumentScreenState extends State<LorryDocumentScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryDocumentProvider>(context, listen: false);
  ...
  void saveCurrentIndex() {
    final provider = Provider.of<LorryDocumentProvider>(context, listen: false);
  ...
  void category() async {
    final provider = Provider.of<LorryDocumentProvider>(context, listen: false);
    provider.saveCategoryType("document");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryDocumentProvider>(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                        ...
                        : () async {
                            final provider = Provider.of<LorryDocumentProvider>(
                                context,
                                listen: false);
                            final correctAnswer =
