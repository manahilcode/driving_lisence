...
class _TrafficSignScreenState extends State<TrafficSignScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<LorryTrafficSignProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
    Provider.of<LorryTrafficSignProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBar(title: "traffic sign", leadingIcon: Icons.arrow_back, onLeadingIconPressed: (){}),
           body: Center(
    child: Consumer<LorryTrafficSignProvider>(
            ...
            child: ElevatedButton(
              onPressed: _currentIndex < provider.lorryModels.length - 1
                ...
                _pageController.nextPage(
                  ...
                  : () async {
                final provider =
                Provider.of<LorryTrafficSignProvider>(
                    context,
                    listen: false);
                final correctAnswer =
