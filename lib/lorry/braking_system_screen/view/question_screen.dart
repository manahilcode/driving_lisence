...
class BrakingSystemScreen extends StatefulWidget {
  const BrakingSystemScreen({super.key});

  @override
  State<BrakingSystemScreen> createState() => _BrakingSystemScreenState();
}

class _BrakingSystemScreenState extends State<BrakingSystemScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryBrakingSystemProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
        Provider.of<LorryBrakingSystemProvider>(context, listen: false);
    provider.saveCategoryType("breaking system");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryBrakingSystemProvider>(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                        ...
                        : () async {
                            final provider =
                                Provider.of<LorryBrakingSystemProvider>(context,
                                    listen: false);
                            final correctAnswer =
