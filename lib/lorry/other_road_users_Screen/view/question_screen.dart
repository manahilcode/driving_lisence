...
class OtherRoadUserScreen extends StatefulWidget {
  const OtherRoadUserScreen({super.key});

  @override
  State<OtherRoadUserScreen> createState() => _OtherRoadUserScreenState();
}

class _OtherRoadUserScreenState extends State<OtherRoadUserScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryOtherRoadUsersProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
        Provider.of<LorryOtherRoadUsersProvider>(context, listen: false);
    provider.saveCategoryType("Other Road Users");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryOtherRoadUsersProvider>(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                      ...
                      _pageController.nextPage(
                        ...
                        : () async {
                      final provider =
                      Provider.of<LorryOtherRoadUsersProvider>(
                          context,
                          listen: false);
                      final correctAnswer =
