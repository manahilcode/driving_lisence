...
class _VehicleConditionScreenState extends State<VehicleConditionScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<LorryVehicleConditionProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
    Provider.of<LorryVehicleConditionProvider>(context, listen: false);
    provider.saveCategoryType("traffic_sign");
  }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBar(title: "Vehicle Condition", leadingIcon: Icons.arrow_back, onLeadingIconPressed: (){}),
           body: Center(
    child: Consumer<LorryVehicleConditionProvider>(
            ...
            child: ElevatedButton(
              onPressed: _currentIndex < provider.lorryModels.length - 1
                ...
                _pageController.nextPage(
                  ...
                  : () async {
                final provider =
                Provider.of<LorryVehicleConditionProvider>(
                    context,
                    listen: false);
                final correctAnswer =
