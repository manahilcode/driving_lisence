...
class TheDriverSystemScreen extends StatefulWidget {
  const TheDriverSystemScreen({super.key});

  @override
  State<TheDriverSystemScreen> createState() => _TheDriverSystemScreenState();
}

class _TheDriverSystemScreenState extends State<TheDriverSystemScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryTheDriverSystemProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
        Provider.of<LorryTheDriverSystemProvider>(context, listen: false);
    provider.saveCategory("The Driver System");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryTheDriverSystemProvider>(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                      ...
                      _pageController.nextPage(
                        ...
                        : () async {
                      final provider =
                      Provider.of<LorryTheDriverSystemProvider>(
                          context,
                          listen: false);
                      final correctAnswer =
