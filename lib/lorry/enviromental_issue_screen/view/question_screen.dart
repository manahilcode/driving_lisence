...
class EnviromentIssueScreen extends StatefulWidget {
  const EnviromentIssueScreen({super.key});

  @override
  State<EnviromentIssueScreen> createState() => _EnviromentIssueScreenState();
}

class _EnviromentIssueScreenState extends State<EnviromentIssueScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider =
          Provider.of<LorryEnviromentalIssueProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
        Provider.of<LorryEnviromentalIssueProvider>(context, listen: false);
    provider.saveCategoryType("Enviromental Issue");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Consumer<LorryEnviromentalIssueProvider>(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: _currentIndex < provider.lorryModels.length - 1
                        ...
                        : () async {
                            final provider =
                                Provider.of<LorryEnviromentalIssueProvider>(
                                    context,
                                    listen: false);
                            final correctAnswer =
