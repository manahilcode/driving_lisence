...
class _VehicleLoadingScreenState extends State<VehicleLoadingScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<LorryVehicleLoadingProvider>(context, listen: false);
  ...
  void category() async {
    final provider =
    Provider.of<LorryVehicleLoadingProvider>(context, listen: false);
    provider.saveCategoryType("Vehicle Loading");
  }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBar(title: "Vehicle Loading", leadingIcon: Icons.arrow_back, onLeadingIconPressed: (){}),
           body: Center(
    child: Consumer<LorryVehicleLoadingProvider>(
            ...
            child: ElevatedButton(
              onPressed: _currentIndex < provider.lorryModels.length - 1
                ...
                _pageController.nextPage(
                  ...
                  : () async {
                final provider =
                Provider.of<LorryVehicleLoadingProvider>(
                    context,
                    listen: false);
                final correctAnswer =
