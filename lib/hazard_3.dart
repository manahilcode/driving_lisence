...
import 'package:driving_lisence/hazard_4.dart';
import 'package:flutter/material.dart';

class hazard_3 extends StatefulWidget {
  @override
  _hazard_3State createState() => _hazard_3State();
}

class _hazard_3State extends State<hazard_3> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('hazard_3');

  // Method to fetch document fields from Firestore
  Future<Map<String, dynamic>?> fetchAlertData() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('hazard_3.3').get();
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => hazard_4()), // Change this
                        );
                      },
                      child: Container(
                        width: 300,
