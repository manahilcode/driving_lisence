...
import 'package:driving_lisence/safety_margin8.dart';
...
class _SafetyMargin7State extends State<SafetyMargin7> {
  // Holds the selected answer index
  int? selectedAnswerIndex;
  bool isCorrect = false;

  // Replace with your Firestore instance
  final CollectionReference questionCollection = FirebaseFirestore.instance.collection('safety_margin7');

  Future<Map<String, dynamic>> fetchQuestion() async {
    DocumentSnapshot docSnapshot = await questionCollection.doc('safety_margin7.7').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Safety_margin8()),
                        );
                      },
                      child: Container(
                        width: 300,
