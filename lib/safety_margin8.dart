...
import 'package:driving_lisence/safety_margin9.dart';
...
class _Safety_margin8State extends State<Safety_margin8> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('safety_margin8');
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('safety_margin8.8').get();
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>Safety_margin9()), // Change this
                        );
                      },
                      child: Container(
                        width: 300,
