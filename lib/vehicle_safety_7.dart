...
class safety7 extends StatefulWidget {
  @override
  _safety7State createState() => _safety7State();
}

class _safety7State extends State<safety7> {
  // Holds the selected answer index
  int? selectedAnswerIndex;
  bool isCorrect = false;

  // Replace with your Firestore instance
  final CollectionReference questionCollection = FirebaseFirestore.instance.collection('safety_7');

  Future<Map<String, dynamic>> fetchQuestion() async {
    DocumentSnapshot docSnapshot = await questionCollection.doc('safety_7.7').get();
                ...
                Center(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Safety8()));
