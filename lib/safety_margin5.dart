...
import 'package:driving_lisence/safety_margin6.dart';
import 'package:driving_lisence/vehicle_safety_8.dart';
import 'package:flutter/material.dart';

class SafetyMargin5 extends StatefulWidget {
  @override
  _SafetyMargin5State createState() => _SafetyMargin5State();
}

class _SafetyMargin5State extends State<SafetyMargin5> {
  // Holds the selected answer index
  int? selectedAnswerIndex;
  bool isCorrect = false;

  // Replace with your Firestore instance
  final CollectionReference questionCollection = FirebaseFirestore.instance.collection('safety_margin5');

  Future<Map<String, dynamic>> fetchQuestion() async {
    DocumentSnapshot docSnapshot = await questionCollection.doc('safety_margin5.5').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SafetyMargin6()),
                        );
                      },
                      child: Container(
                        width: 300,
