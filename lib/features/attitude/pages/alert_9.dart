...
class TipAttitude9 extends StatefulWidget {
  const TipAttitude9({super.key});

  @override
  _TipAttitude9State createState() => _TipAttitude9State();
}

class _TipAttitude9State extends State<TipAttitude9> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('alert_9');

  // Method to fetch document fields from Firestore
  Future<Map<String, dynamic>?> fetchAlertData() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('alert_9.9').get();
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final points = data['Points'] != null
                ...
                : [];
            final title_1 = data['Title_2'];
            final points_1 = data['point_2'] != null
                ? List<String>.from(data['point_2'])
                : [];
