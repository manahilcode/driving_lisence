...
import 'package:driving_lisence/features/essential_document/pages/thing_discuss_practice_instructor.dart';
...
class ThinkAboutEssentialDocument extends StatefulWidget {
  const ThinkAboutEssentialDocument({super.key});

  @override
  State<ThinkAboutEssentialDocument> createState() => _ThinkAboutEssentialDocumentState();
}

class _ThinkAboutEssentialDocumentState extends State<ThinkAboutEssentialDocument> {
  ...
  void didChangeDependencies() {
    ...
    _essentialDocumentsController?.fetchThinkAboutEssential("think_about");
      ...
      body: Consumer<EssentialDocumentsController>(builder: (BuildContext context, value, Widget? child) {
        ...
        return Padding(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Route newRoute = MaterialPageRoute(builder: (context) =>  const ThingDiscussPracticeEssentialDocument());
