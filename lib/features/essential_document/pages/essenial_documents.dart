...
import 'package:driving_lisence/features/essential_document/pages/registering_and_owning_car.dart';
...
class EssentialDocuments extends StatefulWidget {
  const EssentialDocuments({super.key});

  @override
  State<EssentialDocuments> createState() => _EssentialDocumentsState();
}

class _EssentialDocumentsState extends State<EssentialDocuments> {
  ...
  void didChangeDependencies() {
    ...
    _essentialDocumentsController?.fetchEssential("essential_document");
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: const Text("Essential Documents",style: TextStyle(color: Colors.white),),
        centerTitle: true,
        ...
        return Padding(
          ...
          children: [
           ...
           Padding(
            ...
            GestureDetector(
              onTap: () {
                Route newRoute = MaterialPageRoute(builder: (context) =>  const RegisteringOwningCar());
