...
class MotowayDriverQuizScreens extends StatefulWidget {
  const MotowayDriverQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _MotowayDriverQuizScreensState createState() => _MotowayDriverQuizScreensState();
}

class _MotowayDriverQuizScreensState extends State<MotowayDriverQuizScreens> {
  late MotoWayDrivingQuizProvider quizProvider;
  ...
  final String? category = "MotorWay_Driver_Quiz";
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<MotoWayDrivingQuizProvider>(
