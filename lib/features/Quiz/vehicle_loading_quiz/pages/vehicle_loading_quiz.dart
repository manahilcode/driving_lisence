...
class VehicleLoadingQuizScreens extends StatefulWidget {
  const VehicleLoadingQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _VehicleLoadingQuizScreensState createState() => _VehicleLoadingQuizScreensState();
}

class _VehicleLoadingQuizScreensState extends State<VehicleLoadingQuizScreens> {
  late VehicleLoadingQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      quizProvider = Provider.of<VehicleLoadingQuizProvider>(context, listen: false);
  ...
  final String? category = "vehicle_Loading_Quiz";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<VehicleLoadingQuizProvider>(
