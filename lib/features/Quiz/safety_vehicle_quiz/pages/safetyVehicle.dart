...
class SafetyVehicleQuizScreens extends StatefulWidget {
  const SafetyVehicleQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _SafetyVehicleQuizScreensState createState() => _SafetyVehicleQuizScreensState();
}

class _SafetyVehicleQuizScreensState extends State<SafetyVehicleQuizScreens> {
  late SafetyVehicleQuizProvider quizProvider;
  ...
  final String? category = "Safety_Vehicle_Quiz";
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<SafetyVehicleQuizProvider>(
