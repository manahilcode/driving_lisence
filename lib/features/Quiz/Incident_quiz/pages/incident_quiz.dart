...
class IncidentQuizScreens extends StatefulWidget {
  const IncidentQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _IncidentQuizScreensState createState() => _IncidentQuizScreensState();
}

class _IncidentQuizScreensState extends State<IncidentQuizScreens> {
  late IncidentQuizProvider quizProvider;
  ...
  final String? category = "Incident_Emergency_Quiz";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<IncidentQuizProvider>(
