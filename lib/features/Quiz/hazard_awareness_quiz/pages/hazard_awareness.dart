...
class HazardAwarenessQuizScreens extends StatefulWidget {
  const HazardAwarenessQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _HazardAwarenessQuizScreensState createState() => _HazardAwarenessQuizScreensState();
}

class _HazardAwarenessQuizScreensState extends State<HazardAwarenessQuizScreens> {
  late HazardAwarenessQuizProvider quizProvider;
  ...
  final String? category = "Hazard_Awareness_Quiz";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<HazardAwarenessQuizProvider>(
...
class QuizItem extends StatefulWidget {
  ...
  QuizItem(
      {super.key,
        ...
        required this.wrongQuestions, required this.currentIndex});
