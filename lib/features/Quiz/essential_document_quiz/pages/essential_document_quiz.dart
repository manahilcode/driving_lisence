...
class EssentialDocumentQuizScreens extends StatefulWidget {
  const EssentialDocumentQuizScreens({super.key}); // Changed to unnamed constructor

  @override
  _EssentialDocumentQuizScreensState createState() => _EssentialDocumentQuizScreensState();
}

class _EssentialDocumentQuizScreensState extends State<EssentialDocumentQuizScreens> {
  late EssentialDocumentQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      quizProvider = Provider.of<EssentialDocumentQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<EssentialDocumentQuizProvider>(
