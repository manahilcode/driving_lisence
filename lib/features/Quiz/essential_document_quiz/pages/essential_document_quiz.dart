...
class EssentialDocumentQuizScreens extends StatefulWidget {
  ...
  @override
  _EssentialDocumentQuizScreensState createState() =>
      _EssentialDocumentQuizScreensState();
}

class _EssentialDocumentQuizScreensState
    extends State<EssentialDocumentQuizScreens> {
  ...
  final String? category = "Essential_Document_Quiz";
  @override
