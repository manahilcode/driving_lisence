...
import 'package:driving_lisence/features/allertness/pages/thing_discuss_instructor.dart';
import 'package:driving_lisence/features/allertness/viewmodel/controller.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ThinkAboutAlert extends StatefulWidget {
  const ThinkAboutAlert({super.key});

  @override
  State<ThinkAboutAlert> createState() => _ThinkAboutAlertState();
}

class _ThinkAboutAlertState extends State<ThinkAboutAlert> {
  ...
  void didChangeDependencies() {
    ...
    _alertController?.fetchThinkAboutAlert();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      body: Consumer<AlertController>(builder: (BuildContext context, value, Widget? child) {
        final data = value.thinkAboutAlert;
        if(data == null)
          {
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ThingDiscussInstructor()),
                  );
                },
                child: Center(
                  child: Container(
