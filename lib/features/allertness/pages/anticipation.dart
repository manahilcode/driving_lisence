...
class AnticipationAlert extends StatefulWidget {
  ...
  @override
  State<AnticipationAlert> createState() => _AnticipationAlertState();
}

class _AnticipationAlertState extends State<AnticipationAlert> {
  ...
  void didChangeDependencies() {
    ...
    _alertController?.fetchAnticipation();
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: const Text("Anticipation",style: TextStyle(color: Colors.white),),
        centerTitle: true,
        backgroundColor: Colors.green,
      ),
      body: Consumer<AlertController>(builder: (BuildContext context, value, Widget? child) {
        final data = value.anticipation;
        if(data == null)
          {
            ...
            child: Column(
              children: [
               createHeadingText(data.title),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: createHeadingText("Anticipating what other road users might do"),
                ),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const StayFocused()),
                    );
                  },
                  child: Center(
                    child: Container(
