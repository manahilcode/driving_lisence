...
import '../viewmodel/vulnerable_road_provider.dart';

class VulnerableRoadQuizScreen extends StatefulWidget {
  const VulnerableRoadQuizScreen({super.key});

  @override
  _VulnerableRoadQuizScreenState createState() => _VulnerableRoadQuizScreenState();
}

class _VulnerableRoadQuizScreenState extends State<VulnerableRoadQuizScreen> {
  late MotorcycleVulnerableQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleVulnerableQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleVulnerableQuizProvider>(
