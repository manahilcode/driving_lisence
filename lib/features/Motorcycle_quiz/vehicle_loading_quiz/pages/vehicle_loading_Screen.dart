...
import '../viewmodel/motorcycle_loading_provider.dart';

class VehicleLoadingQuizScreen extends StatefulWidget {
  const VehicleLoadingQuizScreen({super.key});

  @override
  _VehicleLoadingQuizScreenState createState() => _VehicleLoadingQuizScreenState();
}

class _VehicleLoadingQuizScreenState extends State<VehicleLoadingQuizScreen> {
  late MotorcycleVehicleLoadingQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleVehicleLoadingQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleVehicleLoadingQuizProvider>(
