...
import '../viewmodel/incident_provider.dart';

class IncidentQuizScreen extends StatefulWidget {
  const IncidentQuizScreen({super.key});

  @override
  _IncidentQuizScreenState createState() => _IncidentQuizScreenState();
}

class _IncidentQuizScreenState extends State<IncidentQuizScreen> {
  late MotorcycleIncidentQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleIncidentQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleIncidentQuizProvider>(
