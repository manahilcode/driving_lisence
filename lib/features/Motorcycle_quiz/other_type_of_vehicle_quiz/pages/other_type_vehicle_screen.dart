...
import '../viewmodel/othertype_motorcyle_provider.dart';
...
class _OtherTypeVehicleQuizScreenState extends State<OtherTypeVehicleQuizScreen> {
  late MotorcycleOtherTypeQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleOtherTypeQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleOtherTypeQuizProvider>(
