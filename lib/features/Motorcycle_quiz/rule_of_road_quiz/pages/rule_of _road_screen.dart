...
import '../viewmodel/rule_of_road_provider.dart';

class RuleOfRoadQuizScreen extends StatefulWidget {
  const RuleOfRoadQuizScreen({super.key});

  @override
  _RuleOfRoadQuizScreenState createState() => _RuleOfRoadQuizScreenState();
}

class _RuleOfRoadQuizScreenState extends State<RuleOfRoadQuizScreen> {
  late MotorcycleRuleOfRoadQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleRuleOfRoadQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleRuleOfRoadQuizProvider>(
