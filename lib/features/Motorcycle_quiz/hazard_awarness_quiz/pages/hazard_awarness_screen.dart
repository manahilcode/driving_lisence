...
import '../viewmodel/hazard_awarness_provider.dart';

class HazardAwarenessQuizScreen extends StatefulWidget {
  const HazardAwarenessQuizScreen({super.key});

  @override
  _HazardAwarenessQuizScreenState createState() => _HazardAwarenessQuizScreenState();
}

class _HazardAwarenessQuizScreenState extends State<HazardAwarenessQuizScreen> {
  late MotorcycleHazardAwarenessQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleHazardAwarenessQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleHazardAwarenessQuizProvider>(
