...
class SafetyMarginQuizScreen extends StatefulWidget {
  const SafetyMarginQuizScreen({super.key});

  @override
  _SafetyMarginQuizScreenState createState() => _SafetyMarginQuizScreenState();
}

class _SafetyMarginQuizScreenState extends State<SafetyMarginQuizScreen> {
  late MotorcycleSafetyMarginQuizProvider quizProvider;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleSafetyMarginQuizProvider>(
