...
import '../viewmodel/road_traffic_Sign_provider.dart';

class RoadTrafficSignQuizScreen extends StatefulWidget {
  const RoadTrafficSignQuizScreen({super.key});

  @override
  _RoadTrafficSignQuizScreenState createState() => _RoadTrafficSignQuizScreenState();
}

class _RoadTrafficSignQuizScreenState extends State<RoadTrafficSignQuizScreen> {
  late MotorcycleRoadTrafficQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleRoadTrafficQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleRoadTrafficQuizProvider>(
