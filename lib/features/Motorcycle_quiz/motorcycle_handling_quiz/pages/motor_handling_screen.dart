...
import '../viewmodel/motorcycle_handling_provider.dart';

class MotorcycleHandlingQuizScreen extends StatefulWidget {
  const MotorcycleHandlingQuizScreen({super.key});

  @override
  _MotorcycleHandlingQuizScreenState createState() => _MotorcycleHandlingQuizScreenState();
}

class _MotorcycleHandlingQuizScreenState extends State<MotorcycleHandlingQuizScreen> {
  late MotorcycleMotorcycleHandlingQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleMotorcycleHandlingQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleMotorcycleHandlingQuizProvider>(
