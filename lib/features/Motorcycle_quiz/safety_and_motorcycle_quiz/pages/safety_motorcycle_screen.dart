...
import '../viewmodel/safety_motorrcyle_provider.dart';

class SafetyMotorcycleQuizScreen extends StatefulWidget {
  const SafetyMotorcycleQuizScreen({super.key});

  @override
  _SafetyMotorcycleQuizScreenState createState() => _SafetyMotorcycleQuizScreenState();
}

class _SafetyMotorcycleQuizScreenState extends State<SafetyMotorcycleQuizScreen> {
  late MotorcycleSafetyMotorcycleQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleSafetyMotorcycleQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleSafetyMotorcycleQuizProvider>(
