...
import '../viewmodel/motorway_driving_provider.dart';

class MotorWayDrivingQuizScreen extends StatefulWidget {
  const MotorWayDrivingQuizScreen({super.key});

  @override
  _MotorWayDrivingQuizScreenState createState() => _MotorWayDrivingQuizScreenState();
}

class _MotorWayDrivingQuizScreenState extends State<MotorWayDrivingQuizScreen> {
  late MotorcycleMotorcycleDrivingQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleMotorcycleDrivingQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleMotorcycleDrivingQuizProvider>(
