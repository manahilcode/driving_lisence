...
class MotorcycleCorrectWrongQuestion extends StatefulWidget {
  // Store correct questions
  final List<String> correctQuestions;
  // Store wrong questions
  final List<String> wrongAnswers;

  const MotorcycleCorrectWrongQuestion({
    super.key,
  ...
  @override
  State<MotorcycleCorrectWrongQuestion> createState() => _MotorcycleCorrectWrongQuestionState();
}

class _MotorcycleCorrectWrongQuestionState extends State<MotorcycleCorrectWrongQuestion>
