...
import 'c_and_w_motorcycle.dart';

class MotorcycleResultScreen extends StatefulWidget {
  ...
  @override
  State<MotorcycleResultScreen> createState() => _MotorcycleResultScreenState();
}

class _MotorcycleResultScreenState extends State<MotorcycleResultScreen> {
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  Route newRoute = MaterialPageRoute(
                      builder: (context) => MotorcycleCorrectWrongQuestion(
                        wrongAnswers: widget
