...
import '../viewmodel/alernes_provider.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  late MotorcycleAllertQuizProvider quizProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      quizProvider = await Provider.of<MotorcycleAllertQuizProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MotorcycleAllertQuizProvider>(
