...
import '../viewmodel/static_hazard_repo.dart';
...
class _StaticHazardScreenState extends State<StaticHazardScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: Consumer<StaticHazardProvider>(
          builder: (context,provider,child) {
            final data = provider.staticHazard;
            if (data == null) {
              return const Center(
                child: LoadingScreen(),
              );
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => RoadSignScreen(), // Replace with your next screen
                        ),
                      );
                    },
                    child: Container(
