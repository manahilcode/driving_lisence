...
import '../viewmodel/hazardoius_load_provider.dart';

class HazardoiusLoadScreen extends StatefulWidget {
  const HazardoiusLoadScreen({super.key});

  @override
  State<HazardoiusLoadScreen> createState() => _HazardoiusLoadScreenState();
}

class _HazardoiusLoadScreenState extends State<HazardoiusLoadScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: Consumer<HazardousLoadProvider>(
