...
import 'package:driving_lisence/features/motorcycle/hazardAwareness/pages/road_condition_screen.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => RoadConditionScreen(), // Replace with your next screen
                        ),
                      );
                    },
                    child: Container(
