...
import 'giving_priority_screen.dart';

class FollowingSafetyScreen extends StatefulWidget {
  const FollowingSafetyScreen({super.key});

  @override
  State<FollowingSafetyScreen> createState() => _FollowingSafetyScreenState();
}
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GivingPriorityScreen(), // Replace with your next screen
                        ),
                      );
                    },
                    child: Container(
