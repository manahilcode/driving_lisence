...
import '../viewmodel/good_manner_on_road_provider.dart';
import 'helping_other_road_Screen.dart';

class GoodMannerRoadscreen extends StatefulWidget {
  const GoodMannerRoadscreen({super.key});

  @override
  State<GoodMannerRoadscreen> createState() => _GoodMannerRoadscreenState();
}
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => HelpingOtherRoadScreen(), // Replace with your next screen
                            ),
                          );
                        },
                        child: Container(
