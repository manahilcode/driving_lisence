...
class LaneAndJunctionScreen extends StatefulWidget {
  ...
  @override
  State<LaneAndJunctionScreen> createState() => _LaneAndJunctionScreenState();
}
...
class _LaneAndJunctionScreenState extends State<LaneAndJunctionScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBar(title: "Lane and Junction", leadingIcon: Icons.arrow_back, onLeadingIconPressed:(){}),
      body: Consumer<LaneAndJunctionProvider>(
          builder: (context,provider,child) {
            final data = provider!.questions;
            if (data == null) {
              return const Center(
                child: LoadingScreen(),
              );
