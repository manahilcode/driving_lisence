...
import '../viewmodel/safety_in_tunnel.dart';
import 'package:provider/provider.dart';

class SafetyInTunnelScreen extends StatefulWidget {
  const SafetyInTunnelScreen({super.key});

  @override
  State<SafetyInTunnelScreen> createState() => _SafetyInTunnelScreenState();
}
...
class _SafetyInTunnelScreenState extends State<SafetyInTunnelScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: "Safety in tunnel",
        leadingIcon: Icons.arrow_back,
        onLeadingIconPressed: () {},
      ),
      body: Consumer<TunnelSafetyNotifier>(builder: (context, provider, child) {
