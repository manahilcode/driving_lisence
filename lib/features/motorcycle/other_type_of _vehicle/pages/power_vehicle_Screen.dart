...
class PowerVehicleScreen extends StatefulWidget {
  ...
  @override
  State<PowerVehicleScreen> createState() => _PowerVehicleScreenState();
}

class _PowerVehicleScreenState extends State<PowerVehicleScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBar(title: "Power vehicle", leadingIcon: Icons.arrow_back, onLeadingIconPressed:(){}),
      body: Consumer<PoweredVehicleInfoNotifier>(
