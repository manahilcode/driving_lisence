...
class _SpeedLimitScreenState extends State<SpeedLimitScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<SpeedLimitQuestionProvider>(context, listen: false);
      provider.fetchSpeedLimitQuestionData();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: Consumer<SpeedLimitQuestionProvider>(
          builder: (context,provider,child) {
            final data = provider.speedLimitQuestionData;
            if (data == null) {
              return const Center(
                child: LoadingScreen(),
              );
