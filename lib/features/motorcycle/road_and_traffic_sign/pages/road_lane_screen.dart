...
class RoadLaneScreen extends StatefulWidget {
  ...
  @override
  State<RoadLaneScreen> createState() => _RoadLaneScreenState();
}

class _RoadLaneScreenState extends State<RoadLaneScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "road lane", leadingIcon: Icons.arrow_back, onLeadingIconPressed:(){}),
      body: Consumer<RoadLanesProvider>(
          builder: (context,provider,child) {
            final data = provider.roadLanesData;
            if (data == null) {
              return const Center(
                child: LoadingScreen(),
              );
