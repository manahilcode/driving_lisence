...
class _DistractionScreenState extends State<DistractionScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<DistractionProvider>(context, listen: false);
      provider.fetchDistractionData("motorcycle_alertness", "Distraction");
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<DistractionProvider>(builder: (context, provider, child) {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BeingSeenOtherScreen(), // Replace with your next screen
                        ),
                      );
                    },
                    child: Container(
