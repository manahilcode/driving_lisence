...
import 'hazard_5.dart';

class hazard_4 extends StatefulWidget {
  @override
  _hazard_4State createState() => _hazard_4State();
}

class _hazard_4State extends State<hazard_4> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('hazard_4');

  // Method to fetch document fields from Firestore
  Future<Map<String, dynamic>?> fetchAlertData() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('hazard_4.4').get();
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => hazard_5()), // Change this
                        );
                      },
                      child: Container(
                        width: 300,
