...
class Safety_5 extends StatefulWidget {
  @override
  _Safety_5State createState() => _Safety_5State();
}

class _Safety_5State extends State<Safety_5> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('safety_5');

  // Function to fetch the image URL from Firestore
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot = await collectionReference.doc('safety_5.5').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Safety_6()), // Change this to the next screen
                        );
                      },
                      child: Container(
                        width: 300,
