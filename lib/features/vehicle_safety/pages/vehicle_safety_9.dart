...
import 'package:driving_lisence/features/vehicle_safety/pages/vehicle_safety10.dart';
import 'package:driving_lisence/features/vehicle_safety/pages/vehicle_safety_8.dart';
import 'package:flutter/material.dart';

class safety9 extends StatefulWidget {
  @override
  _safety9State createState() => _safety9State();
}

class _safety9State extends State<safety9> {
  // Holds the selected answer index
  int? selectedAnswerIndex;
  bool isCorrect = false;

  // Replace with your Firestore instance
  final CollectionReference questionCollection = FirebaseFirestore.instance.collection('safety_9');

  Future<Map<String, dynamic>> fetchQuestion() async {
    DocumentSnapshot docSnapshot = await questionCollection.doc('safety_9.9').get();
                ...
                Center(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Safety10()));
