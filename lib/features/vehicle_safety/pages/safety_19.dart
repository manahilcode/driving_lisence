...
import '../../attitude/pages/alert_10.dart';

class safety_19 extends StatefulWidget {
  @override
  _safety_19State createState() => _safety_19State();
}

class _safety_19State extends State<safety_19> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('safety_19');

  // Method to fetch document fields from Firestore
  Future<Map<String, dynamic>?> fetchAlertData() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('safety_19.19').get();
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
           return const LoadingScreen();
            ...
            final points = data['points'] != null
                ...
                : [];
            final title_1 = data['Title_1'];
            final points_1 = data['points_1'] != null
                ? List<String>.from(data['points_1'])
                : [];
