...
import '../viewmodel/instructor_provider.dart';

class Othertype10 extends StatefulWidget {
  @override
  _Othertype10State createState() => _Othertype10State();
}

class _Othertype10State extends State<Othertype10> {
  bool isLoading = true;
