...
class Othertype6 extends StatefulWidget {
  @override
  _Othertype6State createState() => _Othertype6State();
}

class _Othertype6State extends State<Othertype6> {
  bool isLoading = true;
  ...
  Future<void> _loadData() async {
    try {
      final provider = Provider.of<TramsProvider>(context, listen: false);
      await Future.wait([
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Othertype7(), // Replace with your next screen
                        ),
                      );
                    },
                    child: Container(
