...
import 'package:driving_lisence/features/safety_margin/pages/safety_margin2.dart';
...
class _safety_margin1State extends State<safety_margin1> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('safety_margin1');

  // Function to fetch the image URL from Firestore
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot = await collectionReference.doc('safety_margin1.1').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => safety_margin2()), // Change this to the next screen
                        );
                      },
                      child: Container(
                        width: 300,
