...
import 'package:driving_lisence/features/safety_margin/pages/safety_margin10.dart';
import 'package:flutter/material.dart';

class Safety_margin9 extends StatefulWidget {
  @override
  _Safety_margin9State createState() => _Safety_margin9State();
}

class _Safety_margin9State extends State<Safety_margin9> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection('safety_margin9');
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot =
      await collectionReference.doc('safety_margin9.9').get();
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Text("While driving",style: TextStyle(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Safety_margin10()), // Change this
                        );
                      },
                      child: Container(
                        width: 300,
