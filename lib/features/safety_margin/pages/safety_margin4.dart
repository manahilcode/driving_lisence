...
import 'package:driving_lisence/features/safety_margin/pages/safety_margin5.dart';
import 'package:driving_lisence/features/vehicle_safety/pages/vehicle_safety_6.dart';
import 'package:flutter/material.dart';

import '../../../core/loader.dart';

class safety_margin4 extends StatefulWidget {
  @override
  _safety_margin4State createState() => _safety_margin4State();
}

class _safety_margin4State extends State<safety_margin4> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('safety_margin4');

  // Function to fetch the image URL from Firestore
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot = await collectionReference.doc('safety_margin4.4').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SafetyMargin5()), // Change this to the next screen
                        );
                      },
                      child: Container(
                        width: 300,
