...
class Safety_margin15  extends StatefulWidget {
  @override
  _Safety_margin15State createState() => _Safety_margin15State();
}

class _Safety_margin15State extends State<Safety_margin15> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('safety_margin15');
  ...
  Future<Map<String, dynamic>?> fetchAlertData() async {
    try {
      DocumentSnapshot docSnapshot = await collectionReference.doc('safety_margin15.15').get();
