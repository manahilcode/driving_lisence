...
import 'package:driving_lisence/vehicle_safety14.dart';
...
class _Safety13State extends State<Safety13> {
  // Reference to the Firestore collection
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('safety_13');

  // Function to fetch the image URL from Firestore
  Future<String?> fetchImage() async {
    try {
      DocumentSnapshot docSnapshot = await collectionReference.doc('safety_13.13').get();
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>Safety14()), // Change this to the next screen
                        );
                      },
                      child: Container(
                        width: 300,
