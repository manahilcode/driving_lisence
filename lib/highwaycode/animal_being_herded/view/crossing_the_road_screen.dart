...
class CrossingTheRoadScreenHighway extends StatefulWidget {
  ...
  @override
  State<CrossingTheRoadScreenHighway> createState() =>
      _CrossingTheRoadScreenHighwayState();
}

class _CrossingTheRoadScreenHighwayState
    extends State<CrossingTheRoadScreenHighway> {
  @override
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<PointsProvider>(context, listen: false);
      provider.fetchPoint("Crossing the road");
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<PointsProvider>(builder: (context, provider, child) {
        final data = provider.point;
        if (data == null) {
