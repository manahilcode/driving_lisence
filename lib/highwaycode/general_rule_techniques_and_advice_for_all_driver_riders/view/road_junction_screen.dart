...
class RoadJunctionScreenHighway11  extends StatefulWidget {
  const RoadJunctionScreenHighway11({super.key});

  @override
  State<RoadJunctionScreenHighway11> createState() => _RoadJunctionScreenHighway11State();
}

class _RoadJunctionScreenHighway11State extends State<RoadJunctionScreenHighway11> {
  @override
  void initState() {
